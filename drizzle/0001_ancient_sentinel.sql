...
CREATE TABLE `__new_attendanceRecords` (
	...
	`checkedInAt` integer DEFAULT '"2025-11-23T20:27:02.114Z"' NOT NULL
);
...
CREATE TABLE `__new_sessions` (
	...
	`createdAt` integer DEFAULT '"2025-11-23T20:27:02.114Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2025-11-23T20:27:02.114Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`createdAt` integer DEFAULT '"2025-11-23T20:27:02.114Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2025-11-23T20:27:02.114Z"' NOT NULL,
	`lastSignedIn` integer DEFAULT '"2025-11-23T20:27:02.114Z"' NOT NULL
);
--> statement-breakpoint
