CREATE TABLE `allowed_students` (
	...
	`studentName` text,
	`createdAt` integer DEFAULT '"2025-11-24T00:04:28.336Z"' NOT NULL
);
...
CREATE TABLE `__new_attendanceRecords` (
	...
	`checkedInAt` integer DEFAULT '"2025-11-24T00:04:28.336Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_sessions` (
	...
	`createdAt` integer DEFAULT '"2025-11-24T00:04:28.336Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2025-11-24T00:04:28.336Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`createdAt` integer DEFAULT '"2025-11-24T00:04:28.336Z"' NOT NULL,
	`updatedAt` integer DEFAULT '"2025-11-24T00:04:28.336Z"' NOT NULL,
	`lastSignedIn` integer DEFAULT '"2025-11-24T00:04:28.336Z"' NOT NULL
);
--> statement-breakpoint
